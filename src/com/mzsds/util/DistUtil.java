...
public class DistUtil {
	...
	private static String gDS_File_StorageBasePath = ""; ///Users/mzsds/temp/demobo
	...
	private static String gDS_OSS_BucketName = "";		//mzsdstest
	 ...
	 * eg: String fileID = DistUtil.putFileToDS("/Users/mzsds/Temp/aa.jpg");
	 * 
	 ...
	 * eg: String fileID = DistUtil.putFileToDS("/Users/mzsds/Temp/aa.jpg", true, true, false);
	 ...
	 * eg: boolean a = DistUtil.getFileFromDS("05cf10b1-1532-43b3-b558-97911fb06fd5.jpg", "/Users/mzsds/Temp/aa_1.jpg");
	 * 
	 * @param fileID 文件标识
	...
	public static boolean getFileFromDS(String fileID, String targetFileFullName) {
		...
		try{
			...
			int oriFileSize = Integer.parseInt(dt.getCell(0, "OriFileSize").toString());
